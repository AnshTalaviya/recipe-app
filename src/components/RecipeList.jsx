                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between">
                                    <button className="btn btn-dark btn-sm" onClick={() => setSelectedRecipe(recipe)}>Edit</button>
                                    <button className="btn btn-dark btn-sm" onClick={() => deleteRecipe(recipe.id)}>Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
